...
## Current Version
**V2.1.3** — 本地发布包 / 跨平台部署验证版 / .dockerignore / 部署指南 / 发布清单
...
V2.1.3 是本地发布包 / 跨平台部署验证版。不做新功能，专注整理发布包结构、部署文档和发布验收。
...
| 文档同步 | CHANGELOG +V2.1.2 +V2.1.3 / RELEASE_NOTES 重写 / UPGRADE 补全 |
...
12. start.bat 启动后无健康检查等待（start.sh 有）
