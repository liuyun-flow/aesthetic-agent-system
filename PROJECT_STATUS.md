...
## 下一步建议（2026-06-15 重排版号）
**V2.4 已完成（v2.4.1）**。按用户优先级：**信心版提前为 V2.5**，闭环功能顺延至 **~V3.0**。详见 [ROADMAP.md](ROADMAP.md) 顶部「计划中」。
- **V2.5 信心（下一站，决策已定）**，详见 [docs/V2.5_PLAN.md](docs/V2.5_PLAN.md)：CI（GitHub Actions，付费评测仅 on-release）+ 前端测试/Playwright E2E + 缓存（只缓存视觉描述）+ 成本/延迟遥测。先做 N1 CI + N2 缓存/遥测切片
