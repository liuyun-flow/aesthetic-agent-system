...
V1.8.1 稳定修复 · V1.9 案例库质量管理 · V1.9.1 稳定版 · V2.0 训练评估 · V2.0.1 稳定校准 · V2.1 本地发布版 · V2.1.1 稳定候选 · V2.1.2 热修复 · V2.1.3 发布包 · V2.2 体验优化+评估图表 · V2.2.1 Agent审美内核 · V2.3 一键收藏+描述补全 · V2.4 信任度量（评测台+维度分聚合+Vision直评）
