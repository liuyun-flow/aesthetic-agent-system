...
Aesthetic Training Agent System — 适用于最新版本（版本号见 [Releases](https://github.com/liuyun-flow/aesthetic-agent-system/releases)）
...
从 GitHub Releases 下载最新版 zip 包（文件名形如 `aesthetic-agent-system-vX.Y.Z.zip`，取最新版本），解压到你想要的位置。
