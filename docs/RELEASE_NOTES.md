...
**v1.0.0（2026-06-27）是首个正式稳定版。** 版本线归一：此前 V1.0–V2.6 为 1.0 前的开发迭代编号，现将正式发布版定为 v1.0.0。功能集即此前 V2.6 的全部能力——下方介绍的「Editorial Atelier」UI 高级化改版即随本版交付，连同信任度量与质量基线一并构成首个稳定版。

界面落实后端 `design_knowledge` 所讲的高级感信号：**克制、系统一致、留白、真实材质、大胆尺度对比**。UI 改版仅视觉，无功能或接口改动；所有训练流程、数据、API 保持不变。
